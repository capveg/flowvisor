...
#	hyperargs=['-v0',"-a", "flowvisor-conf.d-readonly","ptcp:%d" % HyperTest.OFPORT ],valgrind=valgrindArgs)

h = FvRegress.parseConfig(configDir='flowvisor-conf.d-readonly', valgrind=valgrindArgs)
...
######################################
	...
	err1 =  FvRegress.OFVERSION + ''' 01 00 0c 01 01 00 00 00 03 00 02'''
...
######################################
	...
	err = FvRegress.OFVERSION + '''01 00 0c 00 00 00 00 00 04 00 00'''
