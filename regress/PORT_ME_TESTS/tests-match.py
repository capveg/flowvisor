...
#			('localhost',54326),
#			],
#	hyperargs=["-v0", "-a", "flowvisor-conf.d-match", "ptcp:%d"% HyperTest.OFPORT],valgrind=valgrindArgs)

h = FvRegress.parseConfig(configDir='flowvisor-conf.d-match', valgrind=valgrindArgs)
