...
#	hyperargs=["-v0", "-a", "flowvisor-conf.d-flood", "ptcp:%d"% HyperTest.OFPORT],valgrind=valgrindArgs)
h = FvRegress.parseConfig(configDir='flowvisor-conf.d-flood', valgrind=valgrindArgs)
