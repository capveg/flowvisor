...
public class ReconnectEvent extends FVTimerEvent {
	 ...
	 * @param secondsToNextReconnect relative time
	 * @param src both the source and the dest of the event
	 */
	public ReconnectEvent(int secondsToNextReconnect, FVEventHandler src) {
		super(0, src, src, null);
		this.setExpireTime(System.currentTimeMillis() + 1000 * secondsToNextReconnect);
	}
