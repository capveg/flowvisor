...
/**
 * Let an event handler know that a config element that it was watching needs updating
 * @author capveg
 *
 */
public class ConfigUpdateEvent extends FVEvent {
	String config;
	/**
	 * @param dst Destination event handler
	 * @param config The config element that needs updating
	 */
