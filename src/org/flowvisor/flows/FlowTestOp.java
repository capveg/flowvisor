...
public class FlowTestOp {
	 ...
	 * @return
	 */
	static TestOp whichTest(FlowIntersect flowIntersect, int wildIndex, int wildX, int wildY) {
		TestOp ret ;
	...
	static short testFieldShort(FlowIntersect flowIntersect, int wildIndex, int wildX, int wildY, short x, short y) {
	...
	static long testFieldLong(FlowIntersect flowIntersect, int wildIndex, int wildX, int wildY, long x, long y) {
	...
	static byte testFieldByte(FlowIntersect flowIntersect, int wildIndex, int wildX, int wildY, byte x, byte y) {
	...
	static byte[] testFieldByteArray(FlowIntersect flowIntersect, int wildIndex, int wildX, int wildY, byte x[], byte y[]) {
